      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            @auth
              <li class="nav-item">
                <a class="nav-link active" href="/appointment">View Appointments  <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
        ...
        <div class="row posts">
            @forelse($appointments as $appointment)
              <div id="1" class="item new col-md-4">
                <a href="/product/{{ $appointment->product_id }}">
                  <div class="featured-item">
                    <img src="/storage/{{ str_replace('\\','/',json_decode($appointment->product_thumbnail)[0]->download_link) }}" alt="">
                    <h4>{{ $appointment->product_name }}</h4>
                    <h6>Approval Status: {{ $appointment->is_approved ? 'Approved' : 'Pending'}}</h6>
                  </div>
                </a>
              </div>
            @empty
